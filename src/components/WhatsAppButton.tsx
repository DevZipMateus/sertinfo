...
const WhatsAppButton = () => {
  ...
  const handleOpenWhatsApp = () => {
    window.open('https://wa.me/5571996695990?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20da%20Sertinfo.', '_blank');
    setIsOpen(false);
  };
      ...
      {isOpen && (
        <div className="mb-4 bg-white rounded-lg shadow-lg p-4 max-w-xs service-card animate-slide-up">
          ...
          <p className="text-gray-600 text-sm mb-3">
            Olá! Estamos aqui para ajudar com suas dúvidas sobre soluções em tecnologia.
          </p>
          <button
